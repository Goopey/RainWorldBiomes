...
import net.rainworld.rainworldbiomes.item.custom.BubbleFruitItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> POPPED_BUBBLE_FRUIT = ITEMS.register("popped_bubble_fruit", 
        () -> new BubbleFruitItem(new Item.Properties().food(ModFoods.POPPED_BUBBLE_FRUIT_FOOD_PROPERTIES)));
